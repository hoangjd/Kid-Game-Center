//
//  AllMemoryCards.swift
//  Kids_Joy_Center
//
//  Created by Joseph Hoang on 3/18/18.
//  Copyright © 2018 Joe Hoang. All rights reserved.
//

import Foundation

class AllMemoryCards {
    var arrayOfCards = [[SingleMemoryCard]]()
    ...
    func setArrayOfCardsIndentifierAndImage() {
        ...
        for i in 0..<identiferArray.count {
            var cardsToAppend = [SingleMemoryCard]()
            for j in 0..<identiferArray[i].count {
                let newCard = SingleMemoryCard()
